...
public class CrimeFragment extends Fragment {
    ...
    public static CrimeFragment newInstance(UUID crimeId) { // метод, который создает объект(?) этого класса
                                                            // по UUID Crime
        ...
        mPhotoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri uri = FileProvider.getUriForFile(getActivity(),
                        "com.example.android.criminalintent.fileprovider", mPhotoFile);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_DATE) {
            ...
            //Выполнение запроса, contactUri здесь выполняет функции "where"
